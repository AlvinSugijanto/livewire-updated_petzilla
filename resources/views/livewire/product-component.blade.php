            ...
            <div class="row">
                ...
                <div class="col-md-7">
                    <div class="container">
                        ...
                        <h3 class="mt-2">Rp: {{ number_format($animal->harga) }}</h4>
                            <hr style="margin: 0em">
                            ...
                            <div class="button-list">
                                <div class="row ml-1 mt-3">
                                    <button class="btn btn-primary" data-toggle="modal" data-target="#addTransactionModal"><i class="fa fa-shopping-cart" aria-hidden="true"></i> Buy Now</button>
                                    <button class="btn btn-default ml-2" style="background-color:#ff9f1a; color:white"><i class="fa fa-heart" aria-hidden="true"></i> Add to wishlist</button>
                                </div>
                            </div>
                    </div>
                </div>
                                ...
                                <div class="card p-2">
                                    ...
                                    <div class="row pl-4 d-flex align-items-center">
                                        ...
                                        <div class="items p-1">
                                            ...
                                            <h6>Warna : hitam</h6>
                                            <h6> Rp. {{ number_format($animal->harga) }} </h6>
                                        </div>
                                    </div>
                                    <hr class="my-2">
