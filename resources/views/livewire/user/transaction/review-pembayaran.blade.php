<div>
    ...
    <div class="card mt-3 shadow-sm pb-4 pt-3 px-4">
        <div class="d-flex align-items-center">
            ...
            <div class="border rounded px-2 py-1 ml-3 font-weight-bold" style="background-color:#FEE5C9; color:#6d400ff7; font-size:0.8rem">Review Pembayaran</div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex">
                                    ...
                                    <div class="d-flex flex-column ml-2 w-50">
                                        ...
                                        <span style="color:rgba(49,53,59,0.68)">{{ $detail->qty }} x Rp. {{ number_format($detail->animal->harga,0,',','.') }}</span>
                                    </div>
