    ...
    <div class="container-fluid mb-5">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="collapse-wrapper py-3">
                    ...
                    <div class="collapse-menu py-3 pr-2 border-bottom">
                        ...
                        <div class="collapse pengajuan_ongkir" id="collapse4">
                            ...
                            <div class="collapse" id="collapse-dikirim-{{$loop->iteration}}">
                                <div class="container border p-2">
                                    <div class="alert alert-primary text-center">Silahkan menunggu user untuk mengkonfirmasi kedatangan</div>
                    ...
                    <div class="collapse-menu py-3 pr-2 border-bottom">
                        ...
                        <div class="collapse pengajuan_ongkir" id="collapse5">
                            ...
                            <div class="d-flex justify-content-between align-items-center mt-2 py-2" data-toggle="collapse" href="#collapse-sampai-{{$loop->iteration}}" role="button" aria-expanded="false" aria-controls="collapseExample">
                                <div class="transaction-item">
                                    <h5 class="transaction"><i class="fa-solid fa-paw text-secondary"></i> {{ $data->animal->judul_post }}</h5>
                                </div>
                                <i class="fa fa-minus" aria-hidden="true"></i>
                ...
                <div class="mt-3">
                    <livewire:store.ongoing-transaction />
                </div>
                @endif
            </div>
        </div>
