<div>
    ...
    <div class="card mt-3 shadow-sm pb-4 pt-3 px-4">
        <div class="d-flex align-items-center">
            ...
            <div class="border rounded px-2 py-1 ml-3 font-weight-bold" style="background-color:#FEE5C9; color:#6d400ff7; font-size:0.8rem">Sedang diproses</div>
        ...
        <div class="d-flex justify-content-end align-items-center mt-2">
            ...
            <button class="btn btn-transaction ml-3 active" style="font-size: 0.9rem;" wire:click.prevent="openProsesModal('{{ $transaction->id_transaction }}')" data-toggle="modal" data-target="#prosesTransaksiModal"><i class="fa-solid fa-file-invoice"></i> Proses Sekarang</button>
                ...
                <div class="modal-body">
                    <div class="container">
                        <div class="d-flex justify-content-between align-items-center mt-1">
                            ...
                            <div class="border rounded px-2 py-1 font-weight-bold d-inline-flex" style="background-color:#FEE5C9; color:#6d400ff7; font-size:0.8rem">Sedang Diproses</div>
                        </div>
                        <div class="d-flex justify-content-between align-items-center mt-1">
