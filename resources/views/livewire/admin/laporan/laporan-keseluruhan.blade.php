        ...
        <div class="card-body">
            ...
            <table class="table mt-4">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>{{ $pembayaran->jenis_rekening }}</td>
                        <td class="text-center">{{ $pembayaran->jumlah }}</td>
                        <td class="text-center">Rp. {{ number_format($pembayaran->grand_total,0,',','.') }}</td>
                    </tr>
                    @endforeach
                    ...
                    <tr class="total gotham" style="font-size:15px; background-color: #e8e8e8;">
                        <td class="font-weight-bold">Total Biaya Pengiriman</td>
                        <td></td>
                        <td class="font-weight-bold text-center">Rp. {{ number_format($total_biaya_pengiriman,0,',','.') }}</td>
                    </tr>
                    <tr class="total gotham" style="font-size:15px; background-color: #e8e8e8;">
